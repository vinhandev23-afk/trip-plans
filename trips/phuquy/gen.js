...
const I = {
  // Unsplash base
  cover:     loadImg('images/cover-island.jpg'),
  rocky:     loadImg('images/rocky-coast.jpg'),
  turquoise: loadImg('images/turquoise-beach.jpg'),
  sunset:    loadImg('images/sunset-rocks.jpg'),
  seafood:   loadImg('images/seafood-spread.jpg'),
  coral:     loadImg('images/coral-snorkel.jpg'),
  lighthouse:loadImg('images/lighthouse.jpg'),
  boats:     loadImg('images/fishing-boats.jpg'),
  vnbeach:   loadImg('images/vietnam-beach.jpg'),
  sunrise:   loadImg('images/sunrise-ocean.jpg'),
  bbq:       loadImg('images/bbq-seafood.jpg'),
  aerial:    loadImg('images/island-aerial.jpg'),
  cliff:     loadImg('images/ocean-cliff.jpg'),
  cafe:      loadImg('images/cafe-ocean.jpg'),
  stars:     loadImg('images/starry-beach.jpg'),
  coral2:    loadImg('images/snorkel-coral2.jpg'),
  road:      loadImg('images/vn-coast-road.jpg'),
  // Real Phú Quý images
  pqWindmill: loadImg('images/Cánh-đồng-quạt-gió-phú-quý-ivivu-1.jpg'),
  pqCrab:     loadImg('images/Cua-Huynh-De-phú-quý-ivivu.jpg'),
  pqHonTranh: loadImg('images/Hòn-Tranh-phú-quý-ivivu.jpg'),
  pqHonDen:   loadImg('images/Hòn-Đen-phú-quý-ivivu.jpg'),
  pqFishPond: loadImg('images/Hồ-cá-Làng-Dương-Phú-Quý-ivivu.jpg'),
  pqBeach21:  loadImg('images/dao-phu-quy-ivivu-21.jpg'),
  pqBeach8:   loadImg('images/dao-phu-quy-ivivu-8.jpg'),
  pqOdau3:    loadImg('images/dao-phu-quy-o-dau-3.jpeg'),
  pqOdau4:    loadImg('images/dao-phu-quy-o-dau-4.jpeg'),
  pqOdau8:    loadImg('images/dao-phu-quy-o-dau-8.jpeg'),
  pqOverview: loadImg('images/du-lich-dao-phu-quy-ivivu.jpg'),
  pqBeach24:  loadImg('images/du-lich-dao-phu-quy-ivivu24.jpg'),
  pqCoast:    loadImg('images/du-lịch-Phú-Quý-ivivu-1.jpg'),
};
...
.idesc{font-size:8pt;font-weight:400;color:#3d4452;line-height:1.6;margin-bottom:4px;}
...
.fc{border:.5px solid var(--line);padding:8px 10px;background:var(--white);page-break-inside:avoid;}
.fc-num{font-family:'Cormorant Garamond',serif;font-size:16pt;font-weight:600;color:var(--teal);line-height:1;float:left;margin-right:7px;margin-top:-2px;}
...
.fc-name{font-size:8pt;font-weight:700;color:var(--ink);display:block;margin-bottom:3px;clear:left;}
.fc-desc{font-size:6.5pt;color:var(--muted);line-height:1.5;}
.fc-price{font-size:6pt;font-weight:700;color:var(--teal);margin-top:3px;display:block;}
  ...
  <div class="body">
    <div class="hero" style="height:56mm;">
      ...
      <div class="hero-txt">
        ...
        <div class="hero-sub">Tàu cao tốc · Bãi Nhỏ · Hải đăng · Gành Hang · Sea La Vie</div>
      </div>
    </div>
    <div class="iti">
      ...
      <div class="irow">
        ...
        <div>
          <div class="ittl">Tàu cao tốc Superdong / Hưng Phát → Đảo</div>
          <div class="idesc">~2.5 giờ trên biển. Ngồi tầng trên chụp hình biển khơi. Uống thuốc say tàu trước 30 phút. Vé Hưng Phát 250k tiết kiệm hơn Superdong 350k.</div>
          <div class="itags"><span class="itag">Book trước 2 tuần</span><span class="itag">Thuốc say tàu!</span></div>
        </div>
      ...
      <div class="irow">
        ...
        <div>
          <div class="ittl">Cảng → Check-in → Bún cá sứa local</div>
          <div class="idesc">Nhận 5 xe máy, check-in homestay, gửi hành lý. Ăn ngay bún cá sứa — đặc sản chỉ có ở Phú Quý, sứa giòn sần sật, nước dùng cá tươi.</div>
          <div class="itags"><span class="itag">Bún cá sứa · ~30k/tô</span><span class="itag">Chỉ có ở Phú Quý</span></div>
        </div>
        <div class="itype tf">Check-in · Food</div>
      </div>

      <div class="irow">
        <div class="itime">10:00<br/>12:00</div>
        <div class="idot-col"><div class="idot fill"></div><div class="ivline"></div></div>
        <div>
          <div class="ittl">★ Bãi Nhỏ — Nước xanh ngọc, cát trắng mịn</div>
          <div class="idesc">Bãi biển đẹp nhất đảo. Nước xanh ngọc bích trong vắt, ít khách. Tắm biển + chụp hình nhóm với background đá đen + nước xanh = siêu lên hình.</div>
          <div class="itags"><span class="itag">Nước xanh ngọc</span><span class="itag">Ít khách</span><span class="itag">Chụp hình #1</span></div>
          <div class="ps c3 ps-h26" style="margin-top:6px;">
            <img src="${I.pqOdau4}" alt="Bãi Nhỏ"/>
            <img src="${I.pqBeach24}" alt="Bãi biển Phú Quý"/>
            <img src="${I.pqOdau3}" alt="Bờ đảo Phú Quý"/>
          </div>
        </div>
      ...
      <div class="irow">
        <div class="itime">12:00<br/>15:30</div>
        <div class="idot-col"><div class="idot"></div><div class="ivline"></div></div>
        <div>
          <div class="ittl">Nghỉ trưa · Hải Đăng Phú Quý (14:30)</div>
          <div class="idesc">Tránh nắng gắt 11h–14h. Sau đó leo hải đăng cao 18m trên núi Cam, 100m trên mực biển — panorama 360° toàn đảo + đại dương. Portrait đỉnh..</div>
          <div class="itags"><span class="itag">View 360° toàn đảo</span><span class="itag">Chụp hình #2</span></div>
        </div>
        <div class="itype to">Nghỉ · Khám phá</div>
      </div>
      ...
      <div class="irow">
        ...
        <div>
          ...
          <div class="idesc">Highlight #1: vách đá đen volcanic sừng sững, Hồ Vô Cực phản chiếu trời. Đến sớm 16h chọn vị trí — 17h hoàng hôn chiếu qua vách đá tạo silhouette cam-hồng rực rỡ trên đá đen.</div>
          ...
          <div class="ps c3 ps-h26" style="margin-top:6px;">
            <img src="${I.pqHonDen}" alt="Hòn Đen vách đá"/>
            <img src="${I.pqOdau8}" alt="Bờ đảo hoang sơ"/>
            <img src="${I.pqBeach21}" alt="Biển xanh Phú Quý"/>
          </div>
        </div>
      ...
      <div class="irow">
        <div class="itime">18:30<br/>22:00</div>
        <div class="idot-col"><div class="idot gold"></div></div>
        <div>
          <div class="ittl">Sea La Vie · Ngắm sao đêm biển</div>
          <div class="idesc">Trending 667K TikTok likes. View biển, kiến trúc đẹp: hàu nướng phô mai, cá nướng lá chuối, cocktail biển. Sau ăn ra bãi ngắm Milky Way — đảo ít đèn, sao cực rõ.</div>
          <div class="itags"><span class="itag">Sea La Vie</span><span class="itag">90–200k/món</span><span class="itag">Milky Way nếu trời trong</span></div>
        </div>
        <div class="itype tf">Food · Đêm</div>
      </div>
  ...
  <div class="body">
    <div class="hero" style="height:56mm;">
      ...
      <div class="hero-txt">
        ...
        <div class="hero-sub">Bãi Doi san hô · Hòn Tranh lặn · Bè cá · Ông Già · Triều Dương · Say Đảo</div>
      </div>
    </div>
    <div class="iti">
      <div class="iti-head"><div class="iti-head-main">Lịch trình chi tiết</div><div class="iti-head-sub">Day 02 · Sáng sớm → Đêm</div></div>

      <div class="irow">
        <div class="itime">04:45<br/>06:30</div>
        <div class="idot-col"><div class="idot coral"></div><div class="ivline"></div></div>
        <div>
          <div class="ittl">★ Sunrise Bãi Doi — San hô lộ thiên</div>
          <div class="idesc">Highlight #2: chạy xe ra Bãi Doi lúc thủy triều rút. Mặt trời nhú lên từ biển, san hô đủ sắc lộ ra mặt nước tạo foreground cực chất cho wide-angle. Mang dép chân mềm.</div>
          ...
          <div class="ps c3 ps-h26" style="margin-top:6px;">
            <img src="${I.pqBeach21}" alt="Bãi san hô"/>
            <img src="${I.sunrise}" alt="Bình minh biển"/>
            <img src="${I.pqOdau8}" alt="Đảo bình minh"/>
          </div>
        </div>
        <div class="itype ts">Sunrise</div>
      </div>

      <div class="irow">
        <div class="itime">06:30<br/>08:30</div>
        <div class="idot-col"><div class="idot"></div><div class="ivline"></div></div>
        <div>
          <div class="ittl">Cà phê sáng · Linh Sơn Tự panorama</div>
          <div class="idesc">Cà phê đá ven đường kiểu đảo. Ghé Linh Sơn Tự — chùa trên đồi cao nhìn ra biển 360°, tượng Phật hướng ra đại dương. Sau đó về homestay mặc đồ bơi.</div>
          <div class="itags"><span class="itag">View đỉnh đảo</span><span class="itag">Chụp hình #5</span></div>
        </div>
        <div class="itype tp">Cà phê · Chụp hình</div>
      </div>

      <div class="irow">
        <div class="itime">09:00<br/>12:00</div>
        <div class="idot-col"><div class="idot fill"></div><div class="ivline"></div></div>
        <div>
          <div class="ittl">★ Lặn ngắm san hô — Hòn Tranh</div>
          <div class="idesc">Highlight #3: thuê ghe 15 phút ra Hòn Tranh. Snorkeling nước trong thấy đáy 5–6m, san hô nhiều màu rực rỡ, cá đàn bơi quanh. Chụp dưới nước bằng GoPro.</div>
          <div class="itags"><span class="itag">Hòn Tranh</span><span class="itag">Nước trong 5–6m</span><span class="itag">~180k/người bao ghe + kính</span><span class="itag">Chụp hình #6</span></div>
          <div class="ps c3 ps-h26" style="margin-top:6px;">
            <img src="${I.pqHonTranh}" alt="Hòn Tranh"/>
            <img src="${I.coral}" alt="San hô lặn biển"/>
            <img src="${I.coral2}" alt="San hô nguyên sơ"/>
          </div>
        </div>
        <div class="itype tm">Snorkeling</div>
      </div>

      <div class="irow">
        <div class="itime">12:00<br/>15:00</div>
        <div class="idot-col"><div class="idot gold"></div><div class="ivline"></div></div>
        <div>
          <div class="ittl">Bè cá Anh Sáng · Nghỉ trưa · Quán Ông Già</div>
          <div class="idesc">Ăn trên bè cá giữa biển — tự chọn tôm hùm, cua mặt trăng từ lồng (150–350k/món). Nghỉ trưa homestay. 15h ghé Ông Già thử cá nóc xào sả ớt — Sài Gòn cấm bán.</div>
          <div class="itags"><span class="itag">Bè cá giữa biển</span><span class="itag">Cá nóc · SG cấm bán</span><span class="itag">Mực nang nướng chao</span></div>
        </div>
        <div class="itype tf">Food Tour #3 · #4</div>
      </div>
      ...
      <div class="irow">
        ...
        <div class="idot-col"><div class="idot coral"></div><div class="ivline"></div></div>
        <div>
          <div class="ittl">★ Triều Dương Bay — Sunset trên bãi dài</div>
          <div class="idesc">Bãi biển dài nhất đảo: sóng nhẹ, hàng dừa, cát mịn. Silhouette đi bộ ven biển lúc hoàng hôn. Khác Gành Hang: bãi mở, sóng, bình yên hơn.</div>
          ...
          <div class="ps c3 ps-h26" style="margin-top:6px;">
            <img src="${I.pqBeach24}" alt="Triều Dương Bay"/>
            <img src="${I.pqCoast}" alt="Bờ biển Phú Quý"/>
            <img src="${I.pqWindmill}" alt="Cánh đồng quạt gió"/>
          </div>
        </div>
        <div class="itype ts">Sunset</div>
      </div>
      ...
      <div class="irow">
        ...
        <div class="idot-col"><div class="idot gold"></div></div>
        <div>
          <div class="ittl">Say Đảo BBQ · Chợ đêm</div>
          <div class="idesc">Trending TikTok 2025–2026. Sò điệp mỡ hành, mực nướng sa tế, ghẹ hấp sả view biển đêm. Sau đó chợ đêm mua quà: mắm Phú Quý, khô mực, mực một nắng.</div>
          <div class="itags"><span class="itag">Say Đảo · Trending TikTok</span><span class="itag">100–250k/món</span><span class="itag">Mắm · Khô làm quà</span></div>
        </div>
        <div class="itype tf">Food Tour #5 · Đêm</div>
      </div>
...
<div class="page">
  <div class="rh">
    <div class="rh-l">Club Trip Phú Quý 2026</div>
    <div class="rh-r">Day 3 · Chủ Nhật 10/5 <span class="rh-dot"></span> 05</div>
  </div>
  <div class="body">
    <div class="hero" style="height:56mm;">
      <img src="${I.pqBeach8}" alt="Biển Phú Quý sáng sớm" style="object-position:center 50%;"/>
      <div class="hero-ov"></div>
      <div class="hero-txt">
        <div class="day-chip gold">Day 03 · Chủ Nhật 10/5</div>
        <div class="hero-ttl">Sáng cuối &<br/>Về đất liền</div>
        <div class="hero-sub">Bình minh · Cháo nhum Cô Bảy · Tàu về · Bánh canh Phan Thiết</div>
      </div>
    </div>
    <div class="iti">
      <div class="iti-head"><div class="iti-head-main">Lịch trình chi tiết</div><div class="iti-head-sub">Day 03 · Sáng cuối & Hành trình về</div></div>
      ...
      <div class="irow">
        ...
        <div>
          ...
          <div class="idesc">Ra biển gần homestay ngắm mặt trời lên lần cuối. Chụp hình tĩnh, cảm nhận sự yên bình trước khi rời đi. Khoảnh khắc đáng nhớ nhất của chuyến đi.</div>
          <div class="itags"><span class="itag">Chụp hình #8 · Khoảnh khắc cuối</span></div>
          <div class="ps c3 ps-h26" style="margin-top:6px;">
            <img src="${I.pqOdau3}" alt="Bờ đảo bình minh"/>
            <img src="${I.pqBeach24}" alt="Bãi biển sáng"/>
            <img src="${I.sunrise}" alt="Bình minh trên biển"/>
          </div>
        </div>
        <div class="itype ts">Sunrise</div>
      </div>
      ...
      <div class="irow">
        ...
        <div class="idot-col"><div class="idot gold"></div><div class="ivline"></div></div>
        <div>
          <div class="ittl">Quán Cô Bảy — Cháo nhum &amp; Bánh xèo đảo</div>
          <div class="idesc">Bữa sáng cuối. Cháo nhum (nhím biển) — bổ dưỡng, vị biển đậm đà, chỉ có ở Phú Quý. Bánh xèo đảo giòn tan. Quán bình dân nhất chuyến đi.</div>
          <div class="itags"><span class="itag">Cháo nhum · SG không có</span><span class="itag">Bánh xèo đảo</span><span class="itag">30–80k/món</span></div>
        </div>
        <div class="itype tf">Food Tour #6</div>
      </div>

      <div class="irow">
        <div class="itime">07:30<br/>10:30</div>
        <div class="idot-col"><div class="idot"></div><div class="ivline"></div></div>
        <div>
          <div class="ittl">Trả phòng · Ra cảng · Tàu về Phan Thiết</div>
          <div class="idesc">Check-out, trả xe tại cảng. Tàu cao tốc 2.5h về Phan Thiết. Tranh thủ ngủ bù, xem lại ảnh. Mang theo quà đã mua đêm qua.</div>
          <div class="itags"><span class="itag">Tàu 08:00 · ~2.5 giờ</span></div>
        </div>
        <div class="itype tm">Check-out · Tàu</div>
      </div>

      <div class="irow">
        <div class="itime">11:00<br/>16:00</div>
        <div class="idot-col"><div class="idot dark"></div></div>
        <div>
          <div class="ittl">Phan Thiết: Bánh canh chả cá · Limousine HCM</div>
          <div class="idesc">Đặc sản Phan Thiết trước khi lên xe: bánh canh chả cá thơm ngọt. Limousine giường nằm 4 giờ về HCM ~16:00. Mang theo kỷ niệm, ảnh đẹp và hương vị biển.</div>
          <div class="itags"><span class="itag">Bánh canh chả cá Phan Thiết</span><span class="itag">Limousine HCM ~4h</span></div>
        </div>
        <div class="itype to">Về nhà</div>
      </div>
    ...
    <div style="padding:8px 15mm 0;">
      ...
      <div class="fgrid">
        <div class="fc"><span class="fc-num">1</span><span class="fc-lbl">Sáng Day 1</span><span class="fc-name">Bún cá sứa · Quán local</span><div class="fc-desc">Sứa giòn + cá tươi, đặc sản đảo</div><span class="fc-price">~30k/tô</span></div>
        <div class="fc"><span class="fc-num">2</span><span class="fc-lbl">Tối Day 1</span><span class="fc-name">Sea La Vie · View biển</span><div class="fc-desc">667K TikTok likes, hàu nướng phô mai</div><span class="fc-price">90–200k/món</span></div>
        <div class="fc"><span class="fc-num">3</span><span class="fc-lbl">Trưa Day 2</span><span class="fc-name">Bè cá Anh Sáng · Giữa biển</span><div class="fc-desc">Tự chọn hải sản từ lồng dưới nước</div><span class="fc-price">150–350k/món</span></div>
        ...
        <div class="fc"><span class="fc-num">5</span><span class="fc-lbl">Tối Day 2</span><span class="fc-name">Say Đảo · BBQ ven biển</span><div class="fc-desc">Trending TikTok, nướng cạnh bãi biển</div><span class="fc-price">100–250k/món</span></div>
...
<div class="page">
  <div class="rh">
    <div class="rh-l">Club Trip Phú Quý 2026</div>
    <div class="rh-r">Budget & Chuẩn bị <span class="rh-dot"></span> 06</div>
  </div>
...
const outPath = __dirname + '/output/phuquy-2026.html';
